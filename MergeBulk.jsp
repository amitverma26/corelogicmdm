...
<%
    ...
    List adptList = context.getSelectedOccurrences();
    Iterator it = adptList.iterator();
    while(it.hasNext()){
        Adaptation adpt = (Adaptation)it.next();
        out.print(adpt.getValueWithoutResolution(Path.parse("./DriverRecord")));
    }
